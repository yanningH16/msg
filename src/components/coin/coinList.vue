    ...
    <div class="delite">
      <div class="header">
        ...
        <div class="block">
          ...
          <el-date-picker v-model="time" type="date" placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss">
          </el-date-picker>
        </div>
      ...
      <div class="table">
        <el-table :data="tableData" style="width: 100%">
          <el-table-column style="margin-left:10px" prop="date" label="接受号码" align="center">
          </el-table-column>
          <el-table-column prop="name" label="短信类型" align="center">
          </el-table-column>
          <el-table-column prop="address" label="内容" align="center">
          </el-table-column>
          <el-table-column prop="payNum" label="日期" align="center">
          </el-table-column>
